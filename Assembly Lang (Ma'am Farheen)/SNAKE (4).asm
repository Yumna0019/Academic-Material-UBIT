...
.model small
.data           
			;This is a data Section That is like a database         
    msg db 'Welcome to the snake game!!',0
    instructions db 10,13,"Use a (left), s (down), d (right) and w (up) to control your snake",10,13,"Press q anytime to quit",10,13, "Press any key to continue$"
...
.code                  
				 ;This is a code section that is executed 
